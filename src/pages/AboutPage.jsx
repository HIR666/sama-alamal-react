...
export default function AboutPage() {
  return (
    <>
      <PageHero
        title="من نحن"
        subtitle="شركة سما الأمل الذهبية العامة محدودة المسؤولية هي شركة عراقية مقرها في بغداد - المأمون، وتعمل في مجال التجارة العامة من خلال المساهمة في استثمار رؤوس الأموال ومزاولة مختلف الأنشطة التجارية المرتبطة بالاستيراد والتصدير والمقايضة وتجهيز السلع والبضائع."
      />
            ...
            <Grid item xs={12} md={6}>
              ...
              <Stack spacing={2.5}>
                <Typography color="text.secondary" sx={{ lineHeight: 2 }}>
                  نعمل في إطار التجارة العامة بكافة صورها المشروعة، مع تركيز
                  واضح على المرونة والاستجابة لاحتياجات السوق المحلي والخارجي،
                  وبما ينسجم مع متطلبات الجهات الحكومية والخاصة والتجارية.
                </Typography>
